...
const menuItems = [
  ...
  {
    key: 2,
    label: paths.simpleForm.name,
    url: paths.simpleForm.getHref(),
  },
  {
    key: 3,
    label: paths.stepperFormRegister.name,
    url: paths.stepperFormRegister.getHref(),
  },
  {
    key: 4,
    label: paths.dynamicForm.name,
    url: paths.dynamicForm.getHref(),
  },
  {
    key: 5,
    label: paths.postDoc.name,
    url: paths.postDoc.getHref(),
  },
];
